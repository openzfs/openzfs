...
#
# DESCRIPTION:
#	'zfs set logicalrefquota/refreserv' can handle incorrect arguments correctly.
#
# STRATEGY:
#	1. Setup incorrect arguments arrays.
#	2. Set the bad argument to logicalrefquota.
...
log_pass "'zfs set logicalrefquota' can handle incorrect arguments correctly."
