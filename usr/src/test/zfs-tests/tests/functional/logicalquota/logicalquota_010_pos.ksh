...
#
# DESCRIPTION:
# A zfs file system logicalquota limits the amount of pool logical 
# space available to a given ZFS file system dataset. Once exceeded, it
# is impossible to write any more files to the file system.
#
# STRATEGY:
# 1) Enable compression to ZFS file system
# 2) Apply logicalquota to the ZFS file system dataset
...
#
log_must exceed_logicalquota $TESTPOOL/$TESTCTR/$TESTFS1 $TESTDIR1

log_pass "Could not write file. logicalquota limit enforced as expected"
