...
#
# STRATEGY:
# 1) Apply logicalquota to ZFS file system dataset
# 2) Create a file which is larger than the set logicalquota
# 3) Verify that the resulting file size is less than the logicalquota limit
#
