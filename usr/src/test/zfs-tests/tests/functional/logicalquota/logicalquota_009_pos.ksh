...
#
# DESCRIPTION:
# A ZFS file system logicalquota limits the amount of pool space
# available to a file system dataset. Apply a logicalquota and verify
...
# 2) Apply logicalquota to ZFS file system dataset
...
log_assert "Verify that file size is limited by the file system logicalquota" \
    "(dataset version)"
...
#
log_must fill_logicalquota $TESTPOOL/$TESTCTR/$TESTFS1 $TESTDIR1
